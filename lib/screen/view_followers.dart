...
class ViewFollowers extends StatefulWidget {
  static const String id = 'view_followers';
  @override
...
class _ViewFollowersState extends State<ViewFollowers> {
  ...
  _initUserDetail() async {
    ...
    followBloc.my_followerPerPage(current_page, my_id);
  ...
  void _scrollListener() {
    if (_controller.position.pixels == _controller.position.maxScrollExtent) {
      ...
      getAllUserFollowersByPage(current_page, my_id).then((value) => {
            followBloc.my_followerHandleListenPerPage(value),
          });
  ...
  Future<void> handleRefresh() async {
    ...
    await getAllUserFollowersByPage(1, my_id).then((value) => {
          followBloc.my_followerHandleListenRefresh(value),
        });
  }
          ...
          child: Column(
            children: [
              ...
              StreamBuilder<List<UserProfile>>(
                  stream: followBloc.followerPerPageStream,
                  builder:
