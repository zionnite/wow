...
class ViewDisUserFollowing extends StatefulWidget {
  static const String id = 'view_dis_user_following';
  String dis_full_name, dis_user_id;

  ViewDisUserFollowing({this.dis_full_name, this.dis_user_id});

  @override
  _ViewDisUserFollowingState createState() => _ViewDisUserFollowingState();
}

class _ViewDisUserFollowingState extends State<ViewDisUserFollowing> {
  ...
  _initUserDetail() async {
    ...
    followBloc.user_followingPerPage(current_page, my_id, widget.dis_user_id);
  ...
  void _scrollListener() {
    if (_controller.position.pixels == _controller.position.maxScrollExtent) {
      ...
      getAll_Dis_UserFollowingByPage(current_page, my_id, widget.dis_user_id)
          .then((value) => {
                followBloc.user_followingHandleListenPerPage(value),
              });
  ...
  Future<void> handleRefresh() async {
    ...
    await getAll_Dis_UserFollowingByPage(1, my_id, widget.dis_user_id)
        .then((value) => {
              followBloc.user_followingHandleListenRefresh(value),
            });
  }
          ...
          child: Column(
            children: [
              ...
              StreamBuilder<List<UserProfile>>(
                  stream: followBloc.userFollowingPerPageStream,
                  builder:
